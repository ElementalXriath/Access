    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row border-bottom">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    <h2>Employees Manager - IN DEVELOPMENT</h2>
                    <ol class="breadcrumb">
                ...
                <div class="col-sm-8">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <h2>Employees</h2>
                            <p>
                                All employers need to be verified before using VEO.
                            </p>
                            <div class="input-group">
                                <input type="text" placeholder="Search employees " class="input form-control">
                            ...
                            <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i>Employees</a></li>
                                    ...
                                    <div class="full-height-scroll">
                                        ...
                                        <ul class="list-group clear-list">
                                            <li class="list-group-item fist-item">
                                                ...
                                                Added Note To Assingment 2018002
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                               ...
                                               Created Invoice for Assingment 20180001
                                            </li>
                                            <li class="list-group-item">
